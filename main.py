...
def main():
    ...
    criterion = [subcriteria_A, subcriteria_B, subcriteria_C, subcriteria_D, subcriteria_E]

    sub_names = [sub_a, sub_b, sub_c, sub_d, sub_e]
    ...
    for criteria_weight, subcriteria_list in zip(weights, subcriteria_weights):
        ...
        for subcriteria_weight in subcriteria_list:
            aggregated_weight = fuzzy_multiplication(subcriteria_weight, criteria_weight)
    ...
    for i in range(3):
        ...
        for x in aggregated_weights:
            for z in x:
                performance = fuzzy_multiplication(z, total_alternative_weights[i])
    ...
    for x, z, y in zip(fuzzy_performance_list[0], fuzzy_performance_list[1], fuzzy_performance_list[2]):
        print(x, z, y)
